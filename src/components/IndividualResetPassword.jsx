...
//         `${API_BASE}/users/resetpassword?token=${token}&newPassword=${newPassword}&confirmPassword=${confirmPassword}`
//       );
...
//     try {
//       const response = await axios.post(
//         `${API_BASE}/users/resetpassword?token=${token}&newPassword=${data.password}&confirmPassword=${data.confirmpassword}`
//       );
...
// import axios from "axios";
// import { FaLock, FaEye, FaEyeSlash } from "react-icons/fa"; // Added FaEye, FaEyeSlash
...
//                 className="w-full pl-10 pr-10 py-2 border rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 dark:bg-gray-700 dark:text-white dark:border-gray-600"
//                 placeholder="Enter Password" // Capitalized
//                 onPaste={(e) => e.preventDefault()}
//                 onCopy={(e) => e.preventDefault()}
//                 {...register("password", {
//                   required: "Password is required",
...
//                 className="w-full pl-10 pr-10 py-2 border rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 dark:bg-gray-700 dark:text-white dark:border-gray-600"
//                 placeholder="Confirm Password" // Capitalized
//                 onPaste={(e) => e.preventDefault()}
//                 onCopy={(e) => e.preventDefault()}
//                 {...register("confirmpassword", {
//                   required: "Confirm password is required",
//                   validate: (value) => value === password || "Passwords must match", // Updated message for consistency
//                 })}
//               />
//               <button
//                 type="button"
...
const IndividualResetPassword = () => {
  ...
  return (
              ...
              <input
                ...
                {...register("password", {
                  ...
                  pattern: {
                    value: /^[A-Z](?=.*[a-z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/,
                    message:
                      "Must start with a capital, include a lowercase, number, and special character, min 9 chars",
                  },
                })}
              />
              <button
   ...
   <p className="text-blue-600 text-center mt-2"> Tip: Make sure to keep your password safe and secure.
</p>
            <div className="flex justify-center space-x-4 mt-4">
              <button

...
const AboutUs = () => {
      ...
      <section className="pt-24 px-4 sm:px-8 lg:px-20 py-12 dark:bg-slate-800 dark:text-white">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-20 dark:bg-slate-800 dark:text-white">
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed dark:text-white">
              <span className="text-3xl font-bold text-gray-900 dark:text-white ">
                CMD<span className="text-cyan-700 dark:text-white">Analytics</span>
              </span>{" "}
              is a business analytics consulting organization with deep expertise in
              implementing BI and AI solutions across industries—from Manufacturing to
              Healthcare—empowering data-driven decision-making and growth.
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-bold mb-4 text-black dark:text-white">Our Values</h3>
            <ul className="list-disc list-inside text-gray-700 space-y-3 dark:text-white">
              <li className="dark:text-white">
                <strong>CMD<span className="text-cyan-700 dark:text-cyan-400">Analytics</span></strong> is a
                trusted name for providing BI & AI solutions.
              </li>
              <li className="dark:text-white"><strong>Excellence:</strong> Delivering top-notch, impactful experiences.</li>
              <li className="dark:text-white"><strong>Accessibility:</strong> Ensuring inclusive access for all.</li>
              <li className="dark:text-white"><strong>Innovation:</strong> Embracing cutting-edge technologies.</li>
              <li className="dark:text-white"><strong>Collaboration:</strong> Building strong partnerships with clients & educators.</li>
            </ul>
          </motion.div>
        </div>
        ...
        >
          <div className="grid md:grid-cols-2 items-center gap-12 dark:bg-slate-800 dark:text-white">
            ...
            <div className="dark:bg-slate-800 dark:text-white">
              <h3 className="text-4xl font-bold text-gray-900 mb-4 dark:text-white">
                Get in <span className="text-cyan-700   dark:text-white">Touch</span>
              </h3>
              <p className="text-gray-700 text-lg mb-6 leading-relaxed dark:text-white">
                We're here to help! Feel free to reach out for any business inquiries, project collaborations, or support. Our team is always ready to connect.
              </p>
              ...
              <div className="space-y-4 dark:bg-slate-800 dark:text-white">
                <div className="flex items-center gap-3 text-gray-700 text-lg dark:text-white">
                  <FaEnvelope className="text-sky-500 text-xl " />
                  <a href="mailto:admin@aycanalytics.com" className="hover:underline dark:text-white">
                    admin@aycanalytics.com
                  </a>
                </div>
                <div className="flex items-center gap-3 text-gray-700 text-lg dark:text-white">
  ...
  <img src="/ayclogo2.png" alt="ayclogo" className="w-44 h-28 object-contain" />
          ...
          <div className="mt-12 flex flex-col items-center text-sm text-gray-500 dark:bg-slate-800 dark:text-gray-400">
            ...
            {/* Logos Row */}
            <div className="flex items-center justify-center gap-x-10 mb-4 dark:bg-slate-800">
              {/* AYC Logo */}
              <img
                src="/ayclogo2.png"
                alt="AYC Logo"
            ...
            <p className="text-center text-gray-600 dark:text-gray-400 text-xs max-w-xl leading-relaxed dark:text-white">
              ...
              <span className="font-semibold dark:text-white"> database provider</span>, powering our analytics
              with reliable and comprehensive financial market data.
            </p>
          </div>
